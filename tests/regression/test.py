...
class ScreenAnalysis():
    ...
    STAGING_URL = 'https://www.yahoo.com'
    PRODUCTION_URL = 'https://www.yahoo.com'
    # driver = None
    ...
    def analyze(self):
        ...
        for y in range(0, screen_height, block_height + 1):
            for x in range(0, screen_width, block_width + 1):
                ...
                if (region_staging is not None and
                        region_production is not None and
                        region_production != region_staging):
